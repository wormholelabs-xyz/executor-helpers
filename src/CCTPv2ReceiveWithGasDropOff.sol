...
/// @title CCTPv2ReceiveWithGasDropOff
/// @author Executor Project Contributors.
/// @notice The CCTPv2ReceiveWithGasDropOff contract is a shim contract that does a Circle receive message and drops off gas at the specified address.
contract CCTPv2ReceiveWithGasDropOff is ICCTPv1ReceiveWithGasDropOff {
